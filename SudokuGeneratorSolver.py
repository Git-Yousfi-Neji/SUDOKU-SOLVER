...
if __name__ == '__main__':
	...
	question_board_code = board.generateQuestionBoardCode(difficulty) # generates a sudoku based on the difficulty 
	print(question_board_code[0])
	board.codeToBoard(question_board_code[0])
	
 
	#code = '300105000060200000008090060050000800800007040071009035000900084704006000902048300'
	solved_board_code = Board(question_board_code[0]).solveForCode()
	print(solved_board_code)
	board.codeToBoard(solved_board_code)